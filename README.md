...
1) Cоздать файл "Файл для копирования.docx"
2) Cоздать папку "Скопировать файл сюда!" 
3) Cоздать несколько файлов с любым названием и расширением, короме названия "Файл для копипрования" и расширения docx

• Для корректной работы автотеста test_with_a_mark.py необходимо:
1) Переключитесь на английскую раскладку
2) Сделайте так, чтобы все окна, кроме открытого браузера с автотестом были свёрнуты 
